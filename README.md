...
2. Download the executable file [`Autosa.exe`]([https://github.com/ThisTemba/autosa/releases/tag/latest](https://github.com/ThisTemba/autosa/releases/latest)) from this repository
