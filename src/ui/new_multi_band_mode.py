...
def confirm_run(self, range_var, run_progress, prog_amt):
    ...
    button_frame = ctk.CTkFrame(run_window, fg_color="transparent")
    ...
    def create_widgets(self):
        ...
        run_sweep = ctk.CTkButton(
            ...
            command=lambda: confirm_run(
                self, range_var, progress_bar, prog_amt, header_frame
            ),
        )
