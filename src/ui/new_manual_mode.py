...
def get_button_frame(manual_tab):
    """1st frame is the bands B0-B7"""
    button_frame = ctk.CTkFrame(manual_tab)
...
def get_measure_frame(manual_tab):
    """2nd frame is the measurement buttons"""
    measurement_frame = ctk.CTkFrame(manual_tab)
...
def get_time_frame(manual_tab):
    """3rd frame is the time and band information"""
    time_frame = ctk.CTkFrame(manual_tab)
...
def get_manual_mode_layout(manual_tab):
    """calls the three frames"""
    # manual_tab.rowconfigure([0,1,2], weight=1)
    # manual_tab.columnconfigure([0,1,2], weight=1)

    # FRAME 1: Buttons
    get_button_frame(manual_tab)

    # FRAME 2: Measurement Buttons
    get_measure_frame(manual_tab)

    # FRAME 3: Stopwatch Frame
    get_time_frame(manual_tab)
